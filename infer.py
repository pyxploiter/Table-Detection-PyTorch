...
parser.add_argument("-p", dest="test_images_path", help="Path to test data images.", required=True)
parser.add_argument("-c", dest="checkpoint_path", help="Input checkpoint file path.", required=True)

options = parser.parse_args()

# read command line arguments if given, otherwise read it from config file
test_images_path = options.test_images_path
